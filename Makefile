#############################################################################
# Makefile for building: bin/cube-display
# Generated by qmake (3.1) (Qt 5.11.1)
# Project:  cube-display.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile cube-display.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -Ibuild -isystem /usr/include/libdrm -Ibuild -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = cube-display1.0.0
DISTDIR = /home/dani/Documents/cube-display/build/cube-display1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = src/main.cpp \
		...
		src/rotation3d.cpp \
		src/window.cpp \
		src/polygon3d.cpp build/moc_window.cpp
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		cube-display.pro src/matrix.h \
		src/point3d.h \
		src/render_area.h \
		src/rotation3d.h \
		src/window.h \
		src/polygon3d.h src/main.cpp \
		src/matrix.cpp \
		src/point3d.cpp \
		src/render_area.cpp \
		src/rotation3d.cpp \
		src/window.cpp \
		src/polygon3d.cpp
QMAKE_TARGET  = cube-display
DESTDIR       = bin/
TARGET        = bin/cube-display


first: all
####### Build rules

$(TARGET): build/ui_window.h $(OBJECTS)  
	@test -d bin/ || mkdir -p bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: cube-display.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile cube-display.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/matrix.h src/point3d.h src/render_area.h src/rotation3d.h src/window.h src/polygon3d.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/matrix.cpp src/point3d.cpp src/render_area.cpp src/rotation3d.cpp src/window.cpp src/polygon3d.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ui/window.ui $(DISTDIR)/
...
build/moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -Wall -W -dM -E -o build/moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: build/moc_window.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_window.cpp
build/moc_window.cpp: build/ui_window.h \
		src/render_area.h \
		src/point3d.h \
		src/rotation3d.h \
		src/matrix.h \
		...
		build/moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include build/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/dani/Documents/cube-display -I/home/dani/Documents/cube-display -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/8.1.1 -I/usr/include/c++/8.1.1/x86_64-pc-linux-gnu -I/usr/include/c++/8.1.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.1.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.1.1/include-fixed -I/usr/include src/window.h -o build/moc_window.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: build/ui_window.h
compiler_uic_clean:
	-$(DEL_FILE) build/ui_window.h
build/ui_window.h: ui/window.ui \
		/usr/bin/uic \
		src/render_area.h \
		src/point3d.h \
		src/rotation3d.h \
		src/matrix.h
	/usr/bin/uic ui/window.ui -o build/ui_window.h
...
build/main.o: src/main.cpp src/window.h \
		build/ui_window.h \
		src/render_area.h \
		src/point3d.h \
		src/rotation3d.h \
...
build/matrix.o: src/matrix.cpp src/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/matrix.o src/matrix.cpp

build/point3d.o: src/point3d.cpp src/point3d.h \
		src/rotation3d.h \
		src/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/point3d.o src/point3d.cpp

build/render_area.o: src/render_area.cpp src/render_area.h \
		src/point3d.h \
		src/rotation3d.h \
		src/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/render_area.o src/render_area.cpp

build/rotation3d.o: src/rotation3d.cpp src/rotation3d.h \
		src/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/rotation3d.o src/rotation3d.cpp
...
build/polygon3d.o: src/polygon3d.cpp src/polygon3d.h \
		src/point3d.h \
		src/rotation3d.h \
		src/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/polygon3d.o src/polygon3d.cpp
